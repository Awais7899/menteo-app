...
function Subscription({navigation}) {
  ...
  useEffect(() => {
    async function getSubscriptionAndReviews() {
      setLoading(true);
      try {
        ...
        const reviewsResponse = await makeApiRequest('get-testimonials', 'get');
        if (subscriptionResponse.success && reviewsResponse.success) {
    ...
    fetch()
      .then(state => {
        ...
        if (state.isConnected && subscriptionData == null) {
          getSubscriptionAndReviews();
        }
      })
      .catch(err => {
                ...
                <View key={index}>
                  ...
                  <View
                    ...
                    <View
                      ...
                      <Text style={{color: '#C3C0DE'}}>{item.username} </Text>
                    </View>
                  </View>
                </View>
              )}
            ...
            <TouchableOpacity
              ...
              <View
                ...
                <Text
                  ...
                  {subscriptionData && `Save ${subscriptionData[0].save}%`}
                </Text>
              </View>
              <View
                style={{
                ...
                <View>
                  ...
                  <View style={{marginTop: 4}}>
                    <Text
                      ...
                      {subscriptionData && subscriptionData[0].description}
                    </Text>
                  </View>
                </View>
                <View>
                ...
                <View>
                  ...
                  <View style={{marginVertical: 2}}>
                    <Text
                      ...
                      {subscriptionData && subscriptionData[1].description}
                    </Text>
                  </View>
                </View>
                <View>
