...
function ThanksForJoining({navigation}) {
    ...
    <View style={styles.container}>
          ...
          <Text
            ...
            }}>
            {
              getStringBeforeAndAfterLastSpace(
                settings.data?.data?.thank_you_screen_title,
              )?.beforeLastSpace
            }
          </Text>
        </View>
        ...
        <View
          ...
          <View
            ...
            <DesciptionText
              ...
              text={settings.data?.data?.thank_you_screen_description}
              font={15}
            />
          </View>
        </View>
      ...
      <View
        ...
        <TouchableOpacity
          ...
          {/* <Icon name="cross" size={24} color={Colors.White} /> */}
          <Cross
            style={{
              color: Colors.White,
            }}
